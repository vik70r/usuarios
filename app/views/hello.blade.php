...
@section('content')
	<h1>Participantes del proyecto</h1>
	  <div class="list-group">
	    <a href="#" class="list-group-item active">
	      <h4 class="list-group-item-heading">AGREGA TU NOMBRE.</h4>
	      <p class="list-group-item-text">Agrega tu nombre a la lista de desarrolladores del proyecto.</p>
	    </a>
	...
	<hr>
	<h1>Ejercicio Usuarios.</h1>
	<a href="usuarios">Ejercicio Usuarios</a>
@stop